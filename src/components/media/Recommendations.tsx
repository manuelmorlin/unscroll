      ...
      {selectedRec && (
        ...
        >
          <motion.div
            ...
            className="relative w-full flex-1 sm:flex-initial sm:max-w-2xl sm:max-h-[90vh] sm:rounded-2xl rounded-none bg-zinc-900 border-t sm:border border-zinc-800 overflow-hidden flex flex-col"
          >
            {/* Close Button */}
            <button
              onClick={closeModal}
