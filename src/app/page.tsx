...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen cinema-bg text-white overflow-auto sm:overflow-hidden">
      ...
      {/* Navbar */}
      <nav className="fixed top-0 w-full z-50 bg-black/60 backdrop-blur-lg border-b border-red-900/30 pt-12 sm:pt-0">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <Link 
              ...
              className="px-4 sm:px-5 py-2 text-sm sm:text-base bg-gradient-to-r from-red-700 to-red-600 text-white font-semibold rounded-full hover:from-red-600 hover:to-red-500 transition-all shadow-lg shadow-red-900/50 border border-red-500/30 flex items-center justify-center"
            >
      ...
      {/* Hero Section */}
      <section className="pt-44 sm:pt-32 pb-20 px-4 relative">
        {/* Spotlight Effect */}
